package ma.enova.easystock.zynerator.util;

import ma.enova.easystock.zynerator.audit.AuditEntity;
import ma.enova.easystock.zynerator.audit.Log;
import ma.enova.easystock.zynerator.bean.BusinessObject;
import ma.enova.easystock.zynerator.bean.EnumBean;
